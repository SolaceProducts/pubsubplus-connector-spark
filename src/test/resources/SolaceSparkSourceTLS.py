...
auth_scheme_basic = env_vars.get("auth_scheme_basic", "false")
...
options = {
    ...
    "solace.apiProperties.AUTHENTICATION_SCHEME": "AUTHENTICATION_SCHEME_CLIENT_CERTIFICATE",
    "solace.apiProperties.SSL_TRUST_STORE": "/opt/spark/work-dir/solace.jks",
    "solace.apiProperties.SSL_TRUST_STORE_FORMAT": "jks",
    "solace.apiProperties.SSL_TRUST_STORE_PASSWORD": "password",
    "solace.apiProperties.SSL_KEY_STORE": "/opt/spark/work-dir/solace_keystore.jks",
    "solace.apiProperties.SSL_KEY_STORE_FORMAT": "jks",
    "solace.apiProperties.SSL_KEY_STORE_PASSWORD": "password",
    "solace.apiProperties.SSL_VALIDATE_CERTIFICATE": "false",
    "solace.apiProperties.SSL_VALIDATE_CERTIFICATE_HOST": "false",
    "solace.apiProperties.SSL_VALIDATE_CERTIFICATE_DATE": "false",
}
...
if auth_scheme_basic == "true":
    options["solace.apiProperties.AUTHENTICATION_SCHEME"] = "AUTHENTICATION_SCHEME_BASIC"
    del options["solace.apiProperties.SSL_TRUST_STORE"]
    del options["solace.apiProperties.SSL_TRUST_STORE_FORMAT"]
    del options["solace.apiProperties.SSL_TRUST_STORE_PASSWORD"]
    del options["solace.apiProperties.SSL_KEY_STORE"]
    del options["solace.apiProperties.SSL_KEY_STORE_FORMAT"]
    del options["solace.apiProperties.SSL_KEY_STORE_PASSWORD"]
    del options["solace.apiProperties.SSL_VALIDATE_CERTIFICATE"]
    del options["solace.apiProperties.SSL_VALIDATE_CERTIFICATE_HOST"]
    del options["solace.apiProperties.SSL_VALIDATE_CERTIFICATE_DATE"]
...
writer = df \
    ...
    .option("username", "certificate-user") \
