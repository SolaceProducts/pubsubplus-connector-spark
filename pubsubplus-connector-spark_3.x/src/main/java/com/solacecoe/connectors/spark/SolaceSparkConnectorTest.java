...
public class SolaceSparkConnectorTest implements Runnable{

    private final SparkSession sparkSession;

    SolaceSparkConnectorTest(SparkSession sparkSession){
...
//                .option("checkpointLocation", "/Users/sravanthotakura/Documents/Spark45")
        ...
        dataset.writeStream().option("checkpointLocation", "/Users/sravanthotakura/Documents/Spark52").foreachBatch((VoidFunction2<Dataset<Row>, Long>) (dataset1, batchId) -> {
