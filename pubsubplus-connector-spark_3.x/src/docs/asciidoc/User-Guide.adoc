...
Using below options to enable OAuth authentication. For property description please refer to <<Configuration>> section.
...
----
    ...
    .option("solace.oauth.client.auth-server.ssl.validateCertificate", true)
