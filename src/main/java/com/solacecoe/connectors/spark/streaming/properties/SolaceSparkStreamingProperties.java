...
public class SolaceSparkStreamingProperties {
    ...
    public static final String SPARK_RUNTIME_PLATFORM = "sparkRuntimePlatform";
    public static final String SPARK_RUNTIME_PLATFORM_DEFAULT = "DATABRICKS";
    public static final String DATABRICKS_SECRET_SCOPE = "databricksSecretScope";
    public static final String DATABRICKS_CLIENT_ID = "databricksClientId";
    public static final String DATABRICKS_HOST = "databricksHost";
//    public static final String DATABRICKS_SERVICE_PRINCIPAL_ID = "DATABRICKS_SERVICE_PRINCIPAL_ID";
    public static final String DATABRICKS_CLIENT_SECRET = "databricksClientSecret";
    public static final String DATABRICKS_CLIENT_SECRET_REFRESH_INTERVAL = "databricksClientSecretRefreshInterval";
