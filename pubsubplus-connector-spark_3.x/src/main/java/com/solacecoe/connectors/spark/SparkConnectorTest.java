...
//                .option("checkpointLocation", "/Users/sravanthotakura/Documents/Spark45")
        ...
        dataset.writeStream()
                .option("checkpointLocation", "/Users/sravanthotakura/Documents/Spark52")
                .foreachBatch((VoidFunction2<Dataset<Row>, Long>) (dataset1, batchId) -> {
                    System.out.println("Count " + dataset1.count());
                    Dataset<Row> updatedDs = dataset1.drop("Topic", "PartitionKey", "TimeStamp", "Headers", "Id", "Payload");
                    updatedDs.write().option("host", "tcps://mr-connection-09hs04i84ht.messaging.solace.cloud:55443")
                            .option("vpn", "dev-100-nvirginia-demo")
                            .option("username", "solace-cloud-client")
                            .option("password", "oks6u1qlplrlhen326f5ac9b70")
